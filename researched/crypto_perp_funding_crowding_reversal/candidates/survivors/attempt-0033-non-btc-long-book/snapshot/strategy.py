...
higher-edge non-BTC long book, uses a 100-minute cadence, and raises target
weight to test whether the robust dislocation signal has unused risk capacity.
