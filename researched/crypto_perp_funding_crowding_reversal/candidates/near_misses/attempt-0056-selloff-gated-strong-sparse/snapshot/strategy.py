...
higher-edge non-BTC long book, uses a 100-minute cadence, and requires stronger
funding pressure only during market-wide selloff regimes. It uses an 8-hour max
hold to test whether the reversal edge decays before the current 12-hour long
horizon.
