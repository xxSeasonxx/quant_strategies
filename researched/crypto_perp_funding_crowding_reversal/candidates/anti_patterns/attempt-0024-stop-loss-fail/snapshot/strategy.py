...
current 12-hour long horizon. A fixed stop-loss tests whether the left tail can
be cut without truncating the ordinary reversal payoff distribution.
...
def _generate_signal_payloads(
    ...
    exit_controls.setdefault("stop_loss_bps", 140.0)
