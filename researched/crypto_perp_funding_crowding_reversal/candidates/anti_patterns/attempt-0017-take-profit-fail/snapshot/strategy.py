...
It exits on a fixed favorable move as well as max hold, testing whether the
reversal edge should be harvested before the full holding window.
...
def _generate_signal_payloads(
    ...
    exit_controls.setdefault("take_profit_bps", 80.0)
